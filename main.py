    ...
    try:
        for i in range(count - 1, len(links)):
            ...
            try:  
                ...
                cc = f'**Vid.Id:** {str(count).zfill(3)}.** {𝗻𝗮𝗺𝗲𝟭}{MR}.mkv\n**Batch** - **{raw_text0}**'
                cc1 = f'**Pdf.Id:** {str(count).zfill(3)}. {𝗻𝗮𝗺𝗲𝟭}{MR}.pdf \n**Batch** - **{raw_text0}**'
                if "drive" in url:
                    try:
